...
import { ShieldCheck, Eye, Users, Lock, MessageCircle } from "lucide-react";
...
export const Route = createFileRoute("/security")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Event, venue and close protection by PSIRA registered officers." },
    ],
  }),
    ...
    <section className="mx-auto max-w-6xl px-4 py-16">
      <div className="grid items-center gap-10 md:grid-cols-2">
        <div className="relative animate-fade-in-up">
          ...
          <img src={securityImg} alt="KGC security officer" loading="lazy" className="hover-lift w-full rounded-3xl border object-cover shadow-elegant" />
        </div>
        <div>
          ...
          <p className="mt-3 text-muted-foreground">
            Whether it's a private event, a venue, or close protection — our trained officers show up sharp, alert, and professional.
          </p>
